...
import { _dashboard, DASHBOARD_STATUS_OPTIONS } from 'src/_mock';
...
const TABLE_HEAD = [
  { id: 'date', label: 'Date', width: 137 },
  { id: 'whatsAppnumber', label: 'WhatsApp Numbers', width: 200 },
  { id: 'webhookURL', label: 'Webhook URL (For Receiving Messages)', width: 200 },
  {
    id: 'action',
    label: 'Action',
    width: 140,
...
export function DashboardListView() {
  ...
  return (
    <>
      <Card sx={{ mt: 4 }}>
        <CardHeader title={<Typography variant="h6">Home</Typography>} sx={{ pb: 3 }} />
        <Divider />
...
function applyFilter({ inputData, comparator, filters, dateError }) {
  ...
  if (name) {
    inputData = inputData.filter(
      (order) =>
        order.whatsAppNumber.name.toLowerCase().indexOf(name.toLowerCase()) !== -1 ||
        order.whatsAppNumber.email.toLowerCase().indexOf(name.toLowerCase()) !== -1
    );
  }
